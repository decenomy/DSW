Contributing to Birake Core
============================

The Birake Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Birake Core project, and is not to be
confused with overall Birake Network Protocol consensus changes.

Whether a pull request is merged into Birake Core rests with the project merge
...
Patches that change Birake consensus rules are considerably more involved than
...
Where a patchset proposes to change the Birake consensus, it must have been
...
The project leader is the release manager for each Birake Core release.
