Contributing to Peps Core
============================

The Peps Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Peps Core project, and is not to be
confused with overall Peps Network Protocol consensus changes.

Whether a pull request is merged into Peps Core rests with the project merge
...
Patches that change Peps consensus rules are considerably more involved than
...
Where a patchset proposes to change the Peps consensus, it must have been
...
The project leader is the release manager for each Peps Core release.
