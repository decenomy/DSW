Contributing to Suvereno Core
============================

The Suvereno Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Suvereno Core project, and is not to be
confused with overall Suvereno Network Protocol consensus changes.

Whether a pull request is merged into Suvereno Core rests with the project merge
...
Patches that change Suvereno consensus rules are considerably more involved than
...
Where a patchset proposes to change the Suvereno consensus, it must have been
...
The project leader is the release manager for each Suvereno Core release.
