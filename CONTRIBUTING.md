Contributing to Eskacoin Core
============================

The Eskacoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Eskacoin Core project, and is not to be
confused with overall Eskacoin Network Protocol consensus changes.

Whether a pull request is merged into Eskacoin Core rests with the project merge
...
Patches that change Eskacoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Eskacoin consensus, it must have been
...
The project leader is the release manager for each Eskacoin Core release.
