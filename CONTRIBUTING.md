Contributing to DashDiamond Core
============================

The DashDiamond Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the DashDiamond Coreunit tests or QA tests
...
The following applies to code changes to the DashDiamond Core project, and is not to be
confused with overall DashDiamond Network Protocol consensus changes.

Whether a pull request is merged into DashDiamond Core rests with the project merge
...
Patches that change DashDiamond consensus rules are considerably more involved than
...
Where a patchset proposes to change the DashDiamond consensus, it must have been
...
The project leader is the release manager for each DashDiamond Core release.
