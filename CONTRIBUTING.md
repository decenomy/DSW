...
The Kyanite Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Kyanite Core project, and is not to be
confused with overall Kyanite Network Protocol consensus changes.

Whether a pull request is merged into Kyanite Core rests with the project merge
...
Patches that change Kyanite consensus rules are considerably more involved than
...
Where a patchset proposes to change the Kyanite consensus, it must have been
...
The project leader is the release manager for each Kyanite Core release.
