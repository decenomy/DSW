Contributing to Azzure Core
============================

The Azzure Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Azzure Core project, and is not to be
confused with overall Azzure Network Protocol consensus changes.

Whether a pull request is merged into Azzure Core rests with the project merge
...
Patches that change Azzure consensus rules are considerably more involved than
...
Where a patchset proposes to change the Azzure consensus, it must have been
...
The project leader is the release manager for each Azzure Core release.
