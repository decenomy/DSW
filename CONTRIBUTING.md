Contributing to Monk Core
============================

The Monk Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Monk Core project, and is not to be
confused with overall Monk Network Protocol consensus changes.

Whether a pull request is merged into Monk Core rests with the project merge
...
Patches that change Monk consensus rules are considerably more involved than
...
Where a patchset proposes to change the Monk consensus, it must have been
...
The project leader is the release manager for each Monk Core release.
