Contributing to Beacon Core
============================

The Beacon Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Beacon Core project, and is not to be
confused with overall Beacon Network Protocol consensus changes.

Whether a pull request is merged into Beacon Core rests with the project merge
...
Patches that change Beacon consensus rules are considerably more involved than
...
Where a patchset proposes to change the Beacon consensus, it must have been
...
The project leader is the release manager for each Beacon Core release.
