Contributing to CryptoSaga Core
============================

The CryptoSaga Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CryptoSaga Core project, and is not to be
confused with overall CryptoSaga Network Protocol consensus changes.

Whether a pull request is merged into CryptoSaga Core rests with the project merge
...
Patches that change CryptoSaga consensus rules are considerably more involved than
...
Where a patchset proposes to change the CryptoSaga consensus, it must have been
...
The project leader is the release manager for each CryptoSaga Core release.
