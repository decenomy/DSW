Contributing to MobilityCoin Core
============================

The MobilityCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MobilityCoin Core project, and is not to be
confused with overall MobilityCoin Network Protocol consensus changes.

Whether a pull request is merged into MobilityCoin Core rests with the project merge
...
Patches that change MobilityCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the MobilityCoin consensus, it must have been
...
The project leader is the release manager for each MobilityCoin Core release.
