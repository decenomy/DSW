...
# Create zip file of binaries
	cp trittium/src/trittiumd trittium/src/trittium-cli trittium/src/trittium-tx trittium/src/qt/trittium-qt .
	zip Trittium-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip trittiumd trittium-cli trittium-tx trittium-qt
	rm -f trittiumd trittium-cli trittium-tx trittium-qt
