...
# Create zip file of binaries
	cp OWO/src/oneworldd DSW/src/oneworld-cli OWO/src/oneworld-tx OWO/src/qt/oneworld-qt .
	zip OWO-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip oneworldd oneworld-cli oneworld-tx oneworld-qt
	rm -f oneworldd oneworld-cli oneworld-tx oneworld-qt
