...
* Fill in the following data:
    * Application Name: `Dash Diamond Core`
    * Application Version: `2.0.2.0`
    * Application Publisher: `2022 DECENOMY Core Developers`
    * Application Website: `https://dashdiamond.net/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `DashDiamond`
* Add application files:
    * Select the file `dashdiamond-pt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `dashdiamond-1.1.0-win64-setup.exe`
