...
AppId={{E39E9201-452E-444D-A1EE-A68B507AB02E}
AppName={#MyAppName}
...
DefaultDirName={autopf}\DashDiamond
...
OutputDir=.\output
OutputBaseFilename=DashDiamondSetup
...
DefaultGroupName=DashDiamond Core
...
[Files]
Source: ".\package\dashdiamond-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\DashDiamond\DashDiamond-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\DashDiamond\DashDiamond-Qt,strDataDir|{userappdata}\DashDiamond\}');
  Result := True;
end;
