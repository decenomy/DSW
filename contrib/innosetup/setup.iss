...
AppId={{41A23C6F-BB31-49FF-8AA8-53F3C6083E4A}
AppName={#MyAppName}
...
DefaultDirName={autopf}\Eskacoin
...
OutputDir=.\output
OutputBaseFilename=EskacoinSetup
...
DefaultGroupName=Eskacoin Core
...
Name: bootstrap; Description: "Bootstrap blockchain files";  Types: full; ExtraDiskSpaceRequired: 2684354560;
...
[Files]
Source: ".\package\eskacoin-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Eskacoin\Eskacoin-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Eskacoin\Eskacoin-Qt,strDataDir|{userappdata}\Eskacoin\}');
  Result := True;
end;
