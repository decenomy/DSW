...
DefaultDirName={autopf}\MobilityCoin
...
OutputDir=.\output
OutputBaseFilename=MobilityCoinSetup
...
DefaultGroupName=MobilityCoin Core
...
[Files]
Source: ".\package\mobic-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\MobilityCoin\MobilityCoin-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\MobilityCoin\MobilityCoin-Qt,strDataDir|{userappdata}\MobilityCoin\}');
  Result := True;
end;
