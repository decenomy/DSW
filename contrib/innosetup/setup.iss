...
#define MyAppName "Birake Core"
#define MyAppPublisher "2022 DECENOMY Core Developers"
#define MyAppURL "https://birake.com"
#define MyAppExeName "birake-qt.exe"
...
OutputDir=.\output
OutputBaseFilename=BirakeSetup
...
[Files]
Source: ".\package\birake-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Birake\Birake-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Birake\Birake-Qt,strDataDir|{userappdata}\Birake\}');
  Result := True;
end;
