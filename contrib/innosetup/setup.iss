...
AppId={{EF6FB68C-D971-484B-9865-337F2AA2BED7}
AppName={#MyAppName}
...
OutputDir=.\output
OutputBaseFilename=AezoraSetup
...
[Files]
Source: ".\package\aezora-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Aezora\Aezora-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Aezora\Aezora-Qt,strDataDir|{userappdata}\Aezora\}');
  Result := True;
end;
