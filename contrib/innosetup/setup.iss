...
OutputDir=.\output
OutputBaseFilename=AzzureSetup
...
[Files]
Source: ".\package\azzure-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Azzure\Azzure-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Azzure\Azzure-Qt,strDataDir|{userappdata}\Azzure\}');
  Result := True;
end;
