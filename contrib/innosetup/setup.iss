...
DefaultDirName={autopf}\CryptoSaga
...
OutputDir=.\output
OutputBaseFilename=CryptoSagaSetup
...
DefaultGroupName=CryptoSaga Core
...
[Files]
Source: ".\package\cryptosaga-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\CryptoSaga\CryptoSaga-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\CryptoSaga\CryptoSaga-Qt,strDataDir|{userappdata}\CryptoSaga\}');
  Result := True;
end;
