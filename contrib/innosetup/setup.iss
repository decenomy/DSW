...
AppId={{A73E4859-61DF-46E3-A18B-313CFEB0473B}
AppName={#MyAppName}
...
DefaultDirName={autopf}\UltraClear
...
OutputDir=.\output
OutputBaseFilename=UltraClearSetup
...
DefaultGroupName=UltraClear Core
...
[Registry]
Root: "HKCU"; Subkey: "Software\UltraClear\UltraClear-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\UltraClear\UltraClear-Qt,strDataDir|{userappdata}\UltraClear\}');
  Result := True;
end;
