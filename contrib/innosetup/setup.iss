...
AppId={{1972B46E-18BD-4F69-A6B6-F4E5E3269429}
AppName={#MyAppName}
...
[Registry]
Root: "HKCU"; Subkey: "Software\Monk\Monk-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Monk\Monk-Qt,strDataDir|{userappdata}\Monk\}');
  Result := True;
end;
