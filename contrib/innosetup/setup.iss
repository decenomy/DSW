...
#define MyAppURL "https://github.com/decenomy/PEPS"
...
AppId={{30E96A69-3257-4BEA-B6B8-1208B34844C2}
AppName={#MyAppName}
...
Name: bootstrap; Description: "Bootstrap blockchain files";  Types: full; ExtraDiskSpaceRequired: 1503238554;
...
[Files]
Source: ".\package\peps-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Peps\Peps-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Peps\Peps-Qt,strDataDir|{userappdata}\Peps\}');
  Result := True;
end;
