...
DefaultDirName={autopf}\OneWorld
...
OutputDir=.\output
OutputBaseFilename=OneWorldSetup
...
DefaultGroupName=OneWorld Core
...
[Files]
Source: ".\package\oneworld-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\OneWorld\OneWorld-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\OneWorld\OneWorld-Qt,strDataDir|{userappdata}\OneWorld\}');
  Result := True;
end;
