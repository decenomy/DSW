...
AppId={{F61619FC-4B09-44FD-8BE1-10FF6D877372}
AppName={#MyAppName}
...
DefaultDirName={autopf}\CryptoFlow
...
OutputDir=.\output
OutputBaseFilename=CryptoFlowSetup
...
DefaultGroupName=CryptoFlow Core
...
[Files]
Source: ".\package\cryptoflow-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\CryptoFlow\CryptoFlow-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\CryptoFlow\CryptoFlow-Qt,strDataDir|{userappdata}\CryptoFlow\}');
  Result := True;
end;
