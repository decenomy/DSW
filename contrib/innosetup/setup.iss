...
AppId={{A6BB54C5-6EC1-4B91-825B-6344354206D7}
AppName={#MyAppName}
...
DefaultDirName={autopf}\Suvereno
...
OutputDir=.\output
OutputBaseFilename=SuverenoSetup
...
DefaultGroupName=Suvereno Core
...
Name: bootstrap; Description: "Bootstrap blockchain files";  Types: full; ExtraDiskSpaceRequired: 10093173145;
...
[Files]
Source: ".\package\suvereno-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Suvereno\Suvereno-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Suvereno\Suvereno-Qt,strDataDir|{userappdata}\Suvereno\}');
  Result := True;
end;
