...
OutputDir=.\output
OutputBaseFilename=KyaniteSetup
...
[Files]
Source: ".\package\kyanite-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Kyanite\Kyanite-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Kyanite\Kyanite-Qt,strDataDir|{userappdata}\Kyanite\}');
  Result := True;
end;
