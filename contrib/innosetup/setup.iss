...
AppId={{DADDC5D4-A0FE-42D4-BA65-75E1B9772D7B}
AppName={#MyAppName}
...
DefaultDirName={autopf}\Trittium
...
OutputDir=.\output
OutputBaseFilename=TrittiumSetup
...
DefaultGroupName=Trittium Core
...
Name: bootstrap; Description: "Bootstrap blockchain files";  Types: full; ExtraDiskSpaceRequired: 419430400;
...
[Files]
Source: ".\package\trittium-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Trittium\Trittium-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Trittium\Trittium-Qt,strDataDir|{userappdata}\Trittium\}');
  Result := True;
end;
