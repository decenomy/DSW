![Example-Logo](https://avatars.githubusercontent.com/u/42434040?v=4)

# CryptoFlow Masternode Setup Guide
***
## Required
1) **CFL collateral value at current block** ([consult the collateral table](../../README.md#rewards-breakdown))
2) **Local Wallet https://github.com/decenomy/CFL/releases**
...
```
wget -q https://raw.githubusercontent.com/decenomy/CFL/master/contrib/masternodesetup/masternodesetup.sh
```
...
```
cryptoflow-cli getmasternodestatus
```
