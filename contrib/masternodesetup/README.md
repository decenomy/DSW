...
***
## Required
1) **PNY collateral value at current block** ([consult the collateral table](../../README.md#rewards-breakdown))
2) **Local Wallet https://github.com/PeonyTeam/peony/releases**
...
```
wget -q https://raw.githubusercontent.com/PeonyTeam/peony/master/contrib/masternodesetup/masternodesetup.sh
```
...
**ALIAS VPS_IP**:36779 **masternodeprivkey TXhash Output**

		Example:
		MN1 125.67.32.10:36779 w8723KqiiqtiLH6y2ktjfwzuSrNucGAbagpmTmCn1KnNEeQTJKf 12fce79c1a5623aa5b5830abff1a9feb6a682b75ee9fe22c647725a3gef42saa 0
