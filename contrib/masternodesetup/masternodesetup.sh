...
CONFIGFOLDER='/root/.cryptosaga'
COIN_DAEMON='cryptosagad'
COIN_CLI='cryptosaga-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/cryptosagacoin/SAGA/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
