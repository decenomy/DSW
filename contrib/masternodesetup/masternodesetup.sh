...
CONFIGFOLDER='/root/.kyanite'
COIN_DAEMON='kyanited'
COIN_CLI='kyanite-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/kyancoin/KYAN/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
