...
CONFIGFOLDER='/root/.dashdiamond'
COIN_DAEMON='dashdiamondd'
COIN_CLI='dashdiamond-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Dash-Diamond/DASHD/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
