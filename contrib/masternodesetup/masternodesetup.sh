...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='trittium.conf'
CONFIGFOLDER='/root/.trittium'
COIN_DAEMON='trittiumd'
COIN_CLI='trittium-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Trittium/trittium/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
