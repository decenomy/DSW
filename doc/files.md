...
monk.conf           | contains configuration settings for monkd or monk-qt
monkd.pid           | stores the process id of monkd while running
...
debug.log           | contains debug information and general logging generated by monkd or monk-qt
