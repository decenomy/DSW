...
peps.conf           | contains configuration settings for pepsd or peps-qt
pepsd.pid           | stores the process id of pepsd while running
...
debug.log           | contains debug information and general logging generated by pepsd or peps-qt
