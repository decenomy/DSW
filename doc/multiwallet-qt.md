...
In order to support loading of multiple wallets in cryptoflow-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptoflow.cpp.
...
Changes to cryptoflow.cpp
----------------------
cryptoflow.cpp is the entry point into cryptoflow-qt, and as such, will require some minor modifications to provide hooks for
