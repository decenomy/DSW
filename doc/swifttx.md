...
This mechanism has been integrated into Bitcore-Node-CryptoFlow which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CryptoFlow-Project/insight-api-cryptoflow#web-socket-api](https://github.com/CryptoFlow-Project/insight-api-cryptoflow#web-socket-api) 
* API: [https://github.com/CryptoFlow-Project/insight-api-cryptoflow#swifttx-transactions](https://github.com/CryptoFlow-Project/insight-api-cryptoflow#swifttx-transactions) 
...
By default, the CryptoFlow Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CryptoFlow Core daemon:
