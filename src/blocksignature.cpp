...
bool CheckBlockSignature(const CBlock& block, const bool enableP2PKH)
{
    ...
    /** Each block is signed by the private key of the input that is staked. This can be either z__DSW__ or normal UTXO
     *  z__DSW__: Each z__DSW__ has a keypair associated with it. The serial number is a hash of the public key.
