...
public:
    CMainParams()
    {
        ...
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MIN_DEPTH_V2].hashActivationBlock     = uint256S("da04bfab34b8dd88eef94bd0f429556a4d197a0f65bdda2155043cff77570f30");
