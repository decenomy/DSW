...
public:
    CMainParams()
    {
        ...
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MODIFIER_V3].nActivationHeight      = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_EBF].nActivationHeight                    = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MODIFIER_V3].hashActivationBlock      = uint256S("0x0");
        consensus.vUpgrades[Consensus::UPGRADE_EBF].hashActivationBlock                    = uint256S("0x0");
