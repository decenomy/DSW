...
#define __PORT_MAINNET__ 14215
#define __PORT_TESTNET__ 14216
#define __PORT_REGTEST__ 14217
 ...
 * EskaCoin system. There are three: the main network on which people trade goods
