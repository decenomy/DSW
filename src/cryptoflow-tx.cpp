...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CryptoFlow Core cryptoflow-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptoflow-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptoflow transaction") + "\n" +
                               "  cryptoflow-tx [options] -create [commands]   " + _("Create hex-encoded cryptoflow transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptoflow transaction
