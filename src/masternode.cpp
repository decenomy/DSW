...
{
    if (nHeight >= 1200001) return 4 * COIN;
    if (nHeight >= 1000001) return 8 * COIN;
    if (nHeight >= 870501) return 15 * COIN;
    if (nHeight >= 800889) return 30 * COIN;
    if (nHeight >= 500001) return 60 * COIN;
    if (nHeight >= 490001) return 68 * COIN;
    if (nHeight >= 480001) return 70 * COIN;
    if (nHeight >= 470001) return 72 * COIN;
    if (nHeight >= 460001) return 74 * COIN;
    if (nHeight >= 450001) return 76 * COIN;
    if (nHeight >= 440001) return 78 * COIN;
    if (nHeight >= 430001) return 80 * COIN;
    if (nHeight >= 420001) return 82 * COIN;
    if (nHeight >= 410001) return 84 * COIN;
    if (nHeight >= 400001) return 86 * COIN;
    if (nHeight >= 390001) return 88 * COIN;
    if (nHeight >= 380001) return 90 * COIN;
    if (nHeight >= 370001) return 92 * COIN;
    if (nHeight >= 360001) return 94 * COIN;
    if (nHeight >= 350001) return 96 * COIN;
    if (nHeight >= 340001) return 98 * COIN;
    if (nHeight >= 330001) return 100 * COIN;
    if (nHeight >= 320001) return 102 * COIN;
    if (nHeight >= 310001) return 104 * COIN;
    if (nHeight >= 300001) return 106 * COIN;
    if (nHeight >= 290001) return 108 * COIN;
    if (nHeight >= 280001) return 110 * COIN;
    if (nHeight >= 270001) return 120 * COIN;
    if (nHeight >= 260001) return 130 * COIN;
    if (nHeight >= 250001) return 140 * COIN;
    if (nHeight >= 240001) return 150 * COIN;
    if (nHeight >= 230001) return 160 * COIN;
    if (nHeight >= 220001) return 170 * COIN;
    if (nHeight >= 210001) return 180 * COIN;
    if (nHeight >= 200001) return 190 * COIN;
    if (nHeight >= 190001) return 200 * COIN;
    if (nHeight >= 180001) return 210 * COIN;
    if (nHeight >= 170001) return 220 * COIN;
    if (nHeight >= 160001) return 230 * COIN;
    if (nHeight >= 150001) return 240 * COIN;
    if (nHeight >= 140001) return 250 * COIN;
