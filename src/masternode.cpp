...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    if (nHeight > 129999) return 260 * COIN;
    if (nHeight > 119999) return 240 * COIN;
    if (nHeight > 109999) return 220 * COIN;
    if (nHeight > 99999)  return 200 * COIN;
    if (nHeight > 89999)  return 180 * COIN;
    if (nHeight > 79999)  return 160 * COIN;
    if (nHeight > 69999)  return 140 * COIN;
    if (nHeight > 59999)  return 120 * COIN;
    if (nHeight > 49999)  return 100 * COIN;
    if (nHeight > 39999)  return 80 * COIN;
    if (nHeight > 29999)  return 60 * COIN;
    if (nHeight > 19999)  return 40 * COIN;
