...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CryptoSaga cryptosaga-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptosaga-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptosaga transaction") + "\n" +
                               "  cryptosaga-tx [options] -create [commands]   " + _("Create hex-encoded cryptosaga transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptosaga transaction
