...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Kyanite kyanite-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kyanite-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kyanite transaction") + "\n" +
                               "  kyanite-tx [options] -create [commands]   " + _("Create hex-encoded kyanite transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kyanite transaction
