...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Suvereno suvereno-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  suvereno-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded suvereno transaction") + "\n" +
                               "  suvereno-tx [options] -create [commands]   " + _("Create hex-encoded suvereno transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded suvereno transaction
