...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MobilityCoin mobic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mobic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mobic transaction") + "\n" +
                               "  mobic-tx [options] -create [commands]   " + _("Create hex-encoded mobic transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mobic transaction
