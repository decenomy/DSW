                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CryptoFlow Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CryptoFlow address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptoflow: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CryptoFlow Core"), this);
    aboutAction->setStatusTip(tr("Show information about CryptoFlow Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CryptoFlow"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CryptoFlow addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CryptoFlow addresses"));
    ...
    openAction->setStatusTip(tr("Open a CryptoFlow: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CryptoFlow Core help message to get a list with possible CryptoFlow command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CryptoFlow Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CryptoFlow network", "", count));
}
...
{
    QString strTitle = tr("CryptoFlow Core"); // default title
