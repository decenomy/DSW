...
/* Monk GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Monk"
#define QAPP_ORG_DOMAIN "monk.org"
#define QAPP_APP_NAME_DEFAULT "Monk-Qt"
#define QAPP_APP_NAME_TESTNET "Monk-Qt-testnet"
