...
/** Utility functions used by the Birake Qt UI.
 */
namespace GUIUtil
{
...
// Render BIR addresses in monospace font
...
// Parse "birake:" URI into recipient object, return true on successful parsing
