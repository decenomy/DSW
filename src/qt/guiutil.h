...
/** Utility functions used by the Suvereno Qt UI.
 */
namespace GUIUtil
{
...
// Render SUV addresses in monospace font
...
// Parse "suvereno:" URI into recipient object, return true on successful parsing
