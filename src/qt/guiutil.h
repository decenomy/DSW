...
/** Utility functions used by the EskaCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ESK addresses in monospace font
...
// Parse "eskacoin:" URI into recipient object, return true on successful parsing
