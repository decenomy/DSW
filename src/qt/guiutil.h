...
/** Utility functions used by the MobilityCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MOBIC addresses in monospace font
...
// Parse "mobic:" URI into recipient object, return true on successful parsing
