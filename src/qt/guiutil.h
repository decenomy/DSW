...
/** Utility functions used by the Kyanite Qt UI.
 */
namespace GUIUtil
{
...
// Render KYAN addresses in monospace font
...
// Parse "kyanite:" URI into recipient object, return true on successful parsing
