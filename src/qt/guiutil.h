...
/** Utility functions used by the CryptoFlow Qt UI.
 */
namespace GUIUtil
{
...
// Render CryptoFlow addresses in monospace font
...
// Parse "cryptoflow:" URI into recipient object, return true on successful parsing
