...
/** Utility functions used by the CryptoSaga Qt UI.
 */
namespace GUIUtil
{
...
// Render SAGA addresses in monospace font
...
// Parse "cryptosaga:" URI into recipient object, return true on successful parsing
