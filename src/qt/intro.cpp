...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CryptoFlow Core"),
     ...
     * override -datadir in the cryptoflow.conf file in the default data directory
     * (to be consistent with cryptoflowd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
