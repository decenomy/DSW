...
<context>
    ...
    <message>
        ...
        <translation>
&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p align="justify"&gt;
DASHD是一种使用区块链技术的数字在线货币
全球范围内快捷交易，即时，基本为
零的交易费用。DASHD是市场上领先的安全和
隐私加密货币，也是第一个PoS(股权证明)加密货币
实现零币(zDASHD)和零币加注。
&lt;/p&gt;&lt;p align="justify"&gt;
DASHD使用了一个股权证明(PoS)一致系统算法，
允许所有DASHD的所有者参与赚取区块奖励
同时保护网络与完整的节点钱包，以及
...
<context>
    ...
    <message>
        ...
        <translation>禁用所有DASHD特定功能(主节点, 零币, SwiftX, budget)(0-1，默认值:%u)</translation>
    </message>
    <message>
