    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of ESK earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 ESK");
...
void DashboardWidget::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("ESK")
    updateDisplayUnit();
}
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair ESK, zESK
...
void DashboardWidget::onChartRefreshed()
{
	...
	set1->setColor(QColor(214, 76, 76));
