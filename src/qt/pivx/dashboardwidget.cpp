    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of FLS earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 FLS");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair FLS
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(88,126,255));
	set1->setColor(QColor(43,252,250));
