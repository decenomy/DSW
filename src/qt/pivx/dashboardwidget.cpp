    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of PEPS earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 PEPS");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair PEPS, zPEPS
