...
public:
    ...
    void setupUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountPiv->setText(QStringLiteral("0 CFL"));
        ...
        labelPiv->setText(QStringLiteral("CFL"));
...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        btnHowTo->setText(QApplication::translate("DashboardWidget", "How to get CFL", Q_NULLPTR));
