...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("CryptoFlow Core");
    QString versionText = QString(tr("Version v1.3.0.1-MAIN")).arg(QString::fromStdString(FormatFullVersion()));
	...
	QString copyrightTextCfl = QChar(0xA9) + QString(tr(" 2018-2021 The CryptoFlow Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextCfl);
