...
CAmount CRewards::GetBlockValue(int nHeight)
{
    ...
    // ---- Static reward table ----
    if (nHeight > 1600000)      nSubsidy =       400 * COIN;
    else if (nHeight > 1500000) nSubsidy =       500 * COIN;
    else if (nHeight > 1400000) nSubsidy =       600 * COIN;
    else if (nHeight > 1300000) nSubsidy =       700 * COIN;
    else if (nHeight > 1200000) nSubsidy =       600 * COIN;
    else if (nHeight > 1100000) nSubsidy =       500 * COIN;
    else if (nHeight > 1000000) nSubsidy =       400 * COIN;
    else if (nHeight >  900000) nSubsidy =       300 * COIN;
    else if (nHeight >  800000) nSubsidy =       200 * COIN;
    else if (nHeight >  700000) nSubsidy =       100 * COIN;
    else if (nHeight >  524000) nSubsidy =     68.75 * COIN;
    else if (nHeight >  264000) nSubsidy =        80 * COIN;
    else if (nHeight >    4500) nSubsidy =       100 * COIN;
    else if (nHeight >       1) nSubsidy =         1 * COIN;
    else if (nHeight >       0) nSubsidy = 225000000 * COIN;
    else nSubsidy = 0;
    // ---- Static reward table ----
