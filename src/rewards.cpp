...
CAmount CRewards::GetBlockValue(int nHeight)
{
    ...
    // ---- Static reward table ----
    if (nHeight > 700000) nSubsidy =       600 * COIN; // Approximately Old blockchain after block 2000000 - Approximately 50% increase in the rewards
    else if (nHeight > 600000) nSubsidy =       680 * COIN; // Approximately Old blockchain after block 1900000 - Approximately 50% increase in the rewards
    else if (nHeight > 500000) nSubsidy =       760 * COIN; // Approximately Old blockchain after block 1800000 - Approximately 50% increase in the rewards
    else if (nHeight > 400000) nSubsidy =       860 * COIN; // Approximately Old blockchain after block 1700000 - Approximately 50% increase in the rewards
    else if (nHeight > 300000) nSubsidy =       900 * COIN; // Approximately Old blockchain after block 1600000 - Approximately 50% increase in the rewards
    else if (nHeight > 190000) nSubsidy =      1000 * COIN; // Fork block - Approximately 50% increase in the rewards
    else if (nHeight > 156455) nSubsidy =       650 * COIN; // Old blockchain after block 1500000
    else if (nHeight >  56455) nSubsidy =       700 * COIN; // Old blockchain after block 1400000
    else if (nHeight >      1) nSubsidy =       300 * COIN; // Old blockchain after block 2000000
    else if (nHeight >      0) nSubsidy = 610000000 * COIN; //! Premine for sending coins to the coin holders. Final circulating supply is 607,146,002.03072373 CFL so we will emit 610M.
    else                       nSubsidy = 0;
    // ---- Static reward table ----
