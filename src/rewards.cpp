...
CAmount CRewards::GetBlockValue(int nHeight)
{
    ...
    // ---- Static reward table ----
    if (nHeight > 1000000)      nSubsidy =      400 * COIN;
    else if (nHeight >  900000) nSubsidy =      600 * COIN;
    else if (nHeight >  800000) nSubsidy =      800 * COIN;
    else if (nHeight >  700000) nSubsidy =      900 * COIN;
    else if (nHeight >  600000) nSubsidy =      600 * COIN;
    else if (nHeight >  500000) nSubsidy =      400 * COIN;
    else if (nHeight >  400000) nSubsidy =      180 * COIN;
    else if (nHeight >  300000) nSubsidy =      120 * COIN;
    else if (nHeight >  200000) nSubsidy =       60 * COIN;
    else if (nHeight >  100000) nSubsidy =       40 * COIN;
    else if (nHeight >   60000) nSubsidy =       20 * COIN;
    else if (nHeight >       1) nSubsidy =       12 * COIN;
    else if (nHeight >       0) nSubsidy = 25000000 * COIN;
    else                        nSubsidy = 0;
    // ---- Static reward table ----
