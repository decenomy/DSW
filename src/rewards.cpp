...
CAmount CRewards::GetBlockValue(int nHeight)
{
    ...
    // ---- Static reward table ----
    if (nHeight > 1900000)      nSubsidy =   800.00 * COIN;    
    else if (nHeight > 1800000) nSubsidy =   900.00 * COIN;
    else if (nHeight > 1700000) nSubsidy =  1000.00 * COIN;
    else if (nHeight > 1600000) nSubsidy =  1200.00 * COIN;   
    else if (nHeight > 1500000) nSubsidy =  1400.00 * COIN;
    else if (nHeight > 1400000) nSubsidy =  1200.00 * COIN;    
    else if (nHeight > 1300000) nSubsidy =  1000.00 * COIN;    
    else if (nHeight > 1200000) nSubsidy =   800.00 * COIN;
    else if (nHeight > 1100000) nSubsidy =   620.00 * COIN;    
    else if (nHeight > 1000000) nSubsidy =   400.00 * COIN;
    else if (nHeight >  930000) nSubsidy =   200.00 * COIN;
    else if (nHeight >  550000) nSubsidy =    50.00 * COIN;
    else if (nHeight >  450000) nSubsidy =    40.00 * COIN;
    else if (nHeight >  350000) nSubsidy =    35.00 * COIN;
    else if (nHeight >  300000) nSubsidy =    30.00 * COIN;
    else if (nHeight >  250000) nSubsidy =    25.00 * COIN;
    else if (nHeight >  225000) nSubsidy =    23.00 * COIN;
    else if (nHeight >  200000) nSubsidy =    20.00 * COIN;
    else if (nHeight >  180000) nSubsidy =    17.00 * COIN;
    else if (nHeight >  160000) nSubsidy =    14.00 * COIN;
    else if (nHeight >  140000) nSubsidy =    12.50 * COIN;
    else if (nHeight >  129000) nSubsidy =    10.00 * COIN;
    else if (nHeight >  112000) nSubsidy =     7.50 * COIN;
    else if (nHeight >   97000) nSubsidy =     5.00 * COIN;
    else if (nHeight >   82000) nSubsidy =     3.50 * COIN;
    else if (nHeight >   68000) nSubsidy =     2.50 * COIN;
    else if (nHeight >   54000) nSubsidy =     2.00 * COIN;
    else if (nHeight >   42000) nSubsidy =     1.50 * COIN;
    else if (nHeight >   30000) nSubsidy =     1.25 * COIN;
    else if (nHeight >   20000) nSubsidy =     1.00 * COIN;
    else if (nHeight >   10000) nSubsidy =     0.75 * COIN;
    else if (nHeight >     500) nSubsidy =     0.50 * COIN;
    else if (nHeight >     251) nSubsidy =     0.25 * COIN;
    else if (nHeight >       1) nSubsidy =    40.00 * COIN;
    else if (nHeight >       0) nSubsidy = 90000.00 * COIN;
