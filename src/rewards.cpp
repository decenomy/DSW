...
CAmount CRewards::GetBlockValue(int nHeight)
{
    ...
    if (nHeight == consensus.nMintHeight) nSubsidy = consensus.nMintValue + GetBlockValue(nHeight + 1);

    else if (nHeight > 2700000) nSubsidy =     200 * COIN;
    else if (nHeight > 2600000) nSubsidy =     220 * COIN;
    else if (nHeight > 2500000) nSubsidy =     240 * COIN;
    else if (nHeight > 2400000) nSubsidy =     220 * COIN;
    else if (nHeight > 2300000) nSubsidy =     200 * COIN;
    else if (nHeight > 2200000) nSubsidy =     160 * COIN;
    else if (nHeight > 2100000) nSubsidy =     120 * COIN;
    else if (nHeight > 2000000) nSubsidy =      80 * COIN;
    else if (nHeight > 1900000) nSubsidy =      40 * COIN;
    else if (nHeight > 1800000) nSubsidy =      20 * COIN;
    else if (nHeight > 1700000) nSubsidy =      10 * COIN;

    else if (nHeight > 1200000) nSubsidy =       4 * COIN;
    else if (nHeight > 1000000) nSubsidy =       8 * COIN;
    else if (nHeight >  870500) nSubsidy =      15 * COIN;
    else if (nHeight >  800888) nSubsidy =      30 * COIN;
    else if (nHeight >  500000) nSubsidy =      60 * COIN;
    else if (nHeight >  490000) nSubsidy =      68 * COIN;
    else if (nHeight >  480000) nSubsidy =      70 * COIN;
    else if (nHeight >  470000) nSubsidy =      72 * COIN;
    else if (nHeight >  460000) nSubsidy =      74 * COIN;
    else if (nHeight >  450000) nSubsidy =      76 * COIN;
    else if (nHeight >  440000) nSubsidy =      78 * COIN;
    else if (nHeight >  430000) nSubsidy =      80 * COIN;
    else if (nHeight >  420000) nSubsidy =      82 * COIN;
    else if (nHeight >  410000) nSubsidy =      84 * COIN;
    else if (nHeight >  400000) nSubsidy =      86 * COIN;
    else if (nHeight >  390000) nSubsidy =      88 * COIN;
    else if (nHeight >  380000) nSubsidy =      90 * COIN;
    else if (nHeight >  370000) nSubsidy =      92 * COIN;
    else if (nHeight >  360000) nSubsidy =      94 * COIN;
    else if (nHeight >  350000) nSubsidy =      96 * COIN;
    else if (nHeight >  340000) nSubsidy =      98 * COIN;
    else if (nHeight >  330000) nSubsidy =     100 * COIN;
    else if (nHeight >  320000) nSubsidy =     102 * COIN;
    else if (nHeight >  310000) nSubsidy =     104 * COIN;
    else if (nHeight >  300000) nSubsidy =     106 * COIN;
    else if (nHeight >  290000) nSubsidy =     108 * COIN;
    else if (nHeight >  280000) nSubsidy =     110 * COIN;
    else if (nHeight >  270000) nSubsidy =     120 * COIN;
    else if (nHeight >  260000) nSubsidy =     130 * COIN;
    else if (nHeight >  250000) nSubsidy =     140 * COIN;
    else if (nHeight >  240000) nSubsidy =     150 * COIN;
    else if (nHeight >  230000) nSubsidy =     160 * COIN;
    else if (nHeight >  220000) nSubsidy =     170 * COIN;
    else if (nHeight >  210000) nSubsidy =     180 * COIN;
    else if (nHeight >  200000) nSubsidy =     190 * COIN;
    else if (nHeight >  190000) nSubsidy =     200 * COIN;
    else if (nHeight >  180000) nSubsidy =     210 * COIN;
    else if (nHeight >  170000) nSubsidy =     220 * COIN;
    else if (nHeight >  160000) nSubsidy =     230 * COIN;
    else if (nHeight >  150000) nSubsidy =     240 * COIN;
    else if (nHeight >  140000) nSubsidy =     250 * COIN;
    else if (nHeight >  130000) nSubsidy =     260 * COIN;
    else if (nHeight >  120000) nSubsidy =     240 * COIN;
    else if (nHeight >  110000) nSubsidy =     220 * COIN;
    else if (nHeight >  100000) nSubsidy =     200 * COIN;
    else if (nHeight >   90000) nSubsidy =     180 * COIN;
    else if (nHeight >   80000) nSubsidy =     160 * COIN;
    else if (nHeight >   70000) nSubsidy =     140 * COIN;
    else if (nHeight >   60000) nSubsidy =     120 * COIN;
    else if (nHeight >   50000) nSubsidy =     100 * COIN;
    else if (nHeight >   40000) nSubsidy =      80 * COIN;
    else if (nHeight >   30000) nSubsidy =      60 * COIN;
    else if (nHeight >   20000) nSubsidy =      40 * COIN;
    else if (nHeight >       1) nSubsidy =      30 * COIN;
    else if (nHeight >       0) nSubsidy = 6000000 * COIN;
    // ---- Static reward table ----
