...
CAmount CRewards::GetBlockValue(int nHeight)
{
    ...
    // ---- Static reward table ----
    if      (nHeight >    700000) nSubsidy =       20 * COIN;
    else if (nHeight >    600000) nSubsidy =       40 * COIN;
    else if (nHeight >    500000) nSubsidy =       60 * COIN;
    else if (nHeight >    400000) nSubsidy =       80 * COIN;
    else if (nHeight >    300000) nSubsidy =       60 * COIN;
    else if (nHeight >    200000) nSubsidy =       40 * COIN;
    else if (nHeight >    115000) nSubsidy =       20 * COIN;
    else if (nHeight >    100000) nSubsidy =       10 * COIN;
    else if (nHeight >         1) nSubsidy =        5 * COIN;
    else if (nHeight >         0) nSubsidy =  1700000 * COIN;
    else nSubsidy = 20 * COIN;
    // ---- Static reward table ----
