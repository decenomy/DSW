...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"mobic", "preparebudget", &preparebudget, true },
        {"mobic", "submitbudget", &submitbudget, true },
        {"mobic", "mnbudgetvote", &mnbudgetvote, true },
        {"mobic", "getbudgetvotes", &getbudgetvotes, true },
        {"mobic", "getnextsuperblock", &getnextsuperblock, true },
        {"mobic", "getbudgetprojection", &getbudgetprojection, true },
        {"mobic", "getbudgetinfo", &getbudgetinfo, true },
        {"mobic", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"mobic", "mnfinalbudget", &mnfinalbudget, true },
        {"mobic", "checkbudgets", &checkbudgets, true },
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8821/\n";
}
