...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"suvereno", "preparebudget", &preparebudget, true },
        {"suvereno", "submitbudget", &submitbudget, true },
        {"suvereno", "mnbudgetvote", &mnbudgetvote, true },
        {"suvereno", "getbudgetvotes", &getbudgetvotes, true },
        {"suvereno", "getnextsuperblock", &getnextsuperblock, true },
        {"suvereno", "getbudgetprojection", &getbudgetprojection, true },
        {"suvereno", "getbudgetinfo", &getbudgetinfo, true },
        {"suvereno", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"suvereno", "mnfinalbudget", &mnfinalbudget, true },
        {"suvereno", "checkbudgets", &checkbudgets, true },
