...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CryptoFlow features */
        {"cryptoflow", "masternode", &masternode, true, true, false},
        {"cryptoflow", "listmasternodes", &listmasternodes, true, true, false},
        {"cryptoflow", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cryptoflow", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cryptoflow", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cryptoflow", "masternodedebug", &masternodedebug, true, true, false},
        {"cryptoflow", "startmasternode", &startmasternode, true, true, false},
        {"cryptoflow", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cryptoflow", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cryptoflow", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cryptoflow", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cryptoflow", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cryptoflow", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cryptoflow", "mnbudget", &mnbudget, true, true, false},
        {"cryptoflow", "preparebudget", &preparebudget, true, true, false},
        {"cryptoflow", "submitbudget", &submitbudget, true, true, false},
        {"cryptoflow", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cryptoflow", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cryptoflow", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cryptoflow", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cryptoflow", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cryptoflow", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cryptoflow", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cryptoflow", "checkbudgets", &checkbudgets, true, true, false},
        {"cryptoflow", "mnsync", &mnsync, true, true, false},
        {"cryptoflow", "spork", &spork, true, true, false},
        {"cryptoflow", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cryptoflow", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cryptoflowd, or the -server option to cryptoflow-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3334/\n";
}
