...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_101_SERVICES_ENFORCEMENT,                          1), // ON
    MAKE_SPORK_DEF(SPORK_102_FORCE_ENABLED_MASTERNODE ,                     1), // ON
    MAKE_SPORK_DEF(SPORK_103_PING_MESSAGE_SALT,                             1), // ON
    ...
    MAKE_SPORK_DEF(SPORK_108_FORCE_MASTERNODE_MIN_AGE,                      1), // ON
    MAKE_SPORK_DEF(SPORK_109_FORCE_ENABLED_VOTED_MASTERNODE,                1), // ON
