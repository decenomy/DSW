...
static const std::string strSecret1  = "7SqVcgrLDUUZktTfHzXNh5g8qQbGXWpzWZgqLWVPLmPoSqzqK9GR";
static const std::string strSecret2  = "7UjyeEXt2Q7VS8MPSVN3GrivdRFWZ1s9m58JwppJ6pu7XWDPoAQb";
static const std::string strSecret1C = "7Ud2XEnN1UusRDUqX6XrQ99c56gjpsBtac26j5ciXBuAXiQRqDRA";
static const std::string strSecret2C = "7SN5FcqncHBAFrJTcZgbucx3QMvyERBWb1NRjhmYobFd1491eSjV";
static const std::string addr1 = "KpAgAasuj44QRT1uo7rGPoxn69GSpPFD84";
static const std::string addr2 = "KozGCamFwQPVeQvTRp2ZwsHvy8qmEvQkSk";
static const std::string addr1C = "KeX7B2QtufuygEkgEqqk8RY3xZbSrbnaRs";
static const std::string addr2C = "KaWvi5PApmg8iWhEbGVSBBxUP2iCUTZu9s"; 
