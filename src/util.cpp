...
const char * const PIVX_CONF_FILENAME = "birake.conf";
const char * const PIVX_PID_FILENAME = "birake.pid";
const char * const PIVX_MASTERNODE_CONF_FILENAME = "masternode.conf";


// Birake only features
// Masternode
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\birake
// Windows >= Vista: C:\Users\Username\AppData\Roaming\birake
// Mac: ~/Library/Application Support/birake
// Unix: ~/.birake
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Birake";
#else
    fs::path pathRet;
...
static fs::path ZC_GetBaseParamsDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\birakeParams
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\birakeParams
    // Mac: ~/Library/Application Support/birakeParams
    // Unix: ~/.birake-params
#ifdef WIN32
    // Windows
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty birake.conf if it does not exist
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override birake.conf
