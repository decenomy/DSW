...
const char * const PIVX_CONF_FILENAME = "eskacoin.conf";
const char * const PIVX_PID_FILENAME = "eskacoin.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\eskacoin
// Windows >= Vista: C:\Users\Username\AppData\Roaming\eskacoin
// Mac: ~/Library/Application Support/eskacoin
// Unix: ~/.eskacoin
#ifdef WIN32
    // Windows
...
static fs::path ZC_GetBaseParamsDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\eskacoinParams
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\eskacoinParams
    // Mac: ~/Library/Application Support/eskacoinParams
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty eskacoin.conf if it does not exist
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override eskacoin.conf
