...
UniValue dumpwallet(const JSONRPCRequest& request)
{
    ...
    if (!seed_id.IsNull())
    {
        ...
        if (pwalletMain->GetKey(seed_id, seed)) {
            ...
            CExtKey accountKey;            //key at m/purpose'/coin_type'/account' ---> key at m/44'/837'/0'
            CExtKey changeKey;             //key at m/purpose'/coin_type'/account'/change ---> key at m/44'/837'/0'/HDChain::ChangeType::ECOMMERCE.
