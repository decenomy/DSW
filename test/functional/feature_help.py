...
"""Verify that starting sapphire with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sapphire with -? for help text")
        ...
        self.log.info("Start sapphire with -version for version information")
