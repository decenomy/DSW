...
"""Verify that starting cryptoflow with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cryptoflow with -? for help text")
        ...
        self.log.info("Start cryptoflow with -version for version information")
