...
"""Verify that starting mobic with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mobic with -? for help text")
        ...
        self.log.info("Start mobic with -version for version information")
