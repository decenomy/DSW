...
"""Verify that starting kyanite with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kyanite with -? for help text")
        ...
        self.log.info("Start kyanite with -version for version information")
