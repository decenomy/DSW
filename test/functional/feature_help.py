...
"""Verify that starting peps with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start peps with -? for help text")
        ...
        self.log.info("Start peps with -version for version information")
