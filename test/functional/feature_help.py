...
"""Verify that starting flits with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start flits with -? for help text")
        ...
        self.log.info("Start flits with -version for version information")
