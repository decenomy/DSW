...
"""Verify that starting dashdiamond with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dashdiamond with -? for help text")
        ...
        self.log.info("Start dashdiamond with -version for version information")
