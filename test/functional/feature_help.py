...
"""Verify that starting oneworld with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start oneworld with -? for help text")
        ...
        self.log.info("Start oneworld with -version for version information")
