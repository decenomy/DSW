...
"""Verify that starting jackpot with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start jackpot with -? for help text")
        ...
        self.log.info("Start jackpot with -version for version information")
