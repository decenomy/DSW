...
"""Verify that starting __decenomy__ with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start __decenomy__ with -? for help text")
        ...
        self.log.info("Start __decenomy__ with -version for version information")
