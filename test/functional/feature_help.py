...
"""Verify that starting cryptosaga with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cryptosaga with -? for help text")
        ...
        self.log.info("Start cryptosaga with -version for version information")
