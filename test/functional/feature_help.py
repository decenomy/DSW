...
"""Verify that starting eskacoin with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start eskacoin with -? for help text")
        ...
        self.log.info("Start eskacoin with -version for version information")
