...
"""Verify that starting beacon with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start beacon with -? for help text")
        ...
        self.log.info("Start beacon with -version for version information")
