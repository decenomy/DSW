...
"""Verify that starting peony with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start peony with -? for help text")
        ...
        self.log.info("Start peony with -version for version information")
