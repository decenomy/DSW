...
"""Verify that starting monk with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start monk with -? for help text")
        ...
        self.log.info("Start monk with -version for version information")
