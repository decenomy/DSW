...
"""Verify that starting azzure with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start azzure with -? for help text")
        ...
        self.log.info("Start azzure with -version for version information")
