...
"""Verify that starting trittium with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start trittium with -? for help text")
        ...
        self.log.info("Start trittium with -version for version information")
