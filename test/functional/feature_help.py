...
"""Verify that starting birake with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start birake with -? for help text")
        ...
        self.log.info("Start birake with -version for version information")
