...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected BIR supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check BIR supply at the beginning
        # ------------------------------------------
        ...
        # Verify that BIR supplies were properly updated after the spends and reorgs
        self.log.info("Check BIR supply...")
