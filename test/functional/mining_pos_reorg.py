...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected SAGA supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check SAGA supply at the beginning
        # ------------------------------------------
        ...
        # Verify that SAGA supplies were properly updated after the spends and reorgs
        self.log.info("Check SAGA supply...")
