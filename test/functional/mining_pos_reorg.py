...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected 777 supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check 777 supply at the beginning
        # ------------------------------------------
        ...
        # Verify that 777 supplies were properly updated after the spends and reorgs
        self.log.info("Check 777 supply...")
