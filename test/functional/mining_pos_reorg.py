...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected MONK and zMONK supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zMONKsupply']:
                assert_equal(node['zMONKsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check MONK and zMONK supply at the beginning
        # ------------------------------------------
        # zMONK supply: 2 coins for each denomination
        ...
        # MONK supply: block rewards minus burned fees for minting
        ...
        # Verify that MONK and zMONK supplies were properly updated after the spends and reorgs
        self.log.info("Check MONK and zMONK supply...")
