...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected SAGA and zSAGA supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zSAGAsupply']:
                assert_equal(node['zSAGAsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check SAGA and zSAGA supply at the beginning
        # ------------------------------------------
        # zSAGA supply: 2 coins for each denomination
        ...
        # SAGA supply: block rewards minus burned fees for minting
        ...
        # Verify that SAGA and zSAGA supplies were properly updated after the spends and reorgs
        self.log.info("Check SAGA and zSAGA supply...")
